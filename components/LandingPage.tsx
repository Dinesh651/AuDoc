      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
        ...
        <div className="mt-24 grid md:grid-cols-3 gap-8">
          <FeatureCard 
            ...
            description="Structured risk register, materiality worksheets, and checklists aligned with NSA 200-700 series to ensure full compliance."
          />
          <FeatureCard 
            icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" /></svg>}
            title="Collaborative Evidence"
            description="Upload documents, evaluate misstatements against materiality, and sign off every section as preparer and reviewer."
          />
          <FeatureCard 
