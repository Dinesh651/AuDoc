    ...
    <div className="animate-fade-in bg-white p-8 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          <div>
              ...
              <input type="text" value={data.engagementPartnerName} onChange={(e) => updateData({ engagementPartnerName: e.target.value })} className={inputClass} />
          </div>
          <div>
              <label className="block text-sm font-medium text-slate-600 mb-1">Designation</label>
              <input type="text" value={data.designation} onChange={(e) => updateData({ designation: e.target.value })} className={inputClass} />
          </div>
           <div>
              <label className="block text-sm font-medium text-slate-600 mb-1">Firm Name</label>
              <input type="text" value={data.auditFirmName} onChange={(e) => updateData({ auditFirmName: e.target.value })} className={inputClass} />
          </div>
      </div>
